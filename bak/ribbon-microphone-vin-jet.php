					...
					<div class="prod-buy-form">
						<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
							...
							<select class="dropkick" name="os0">
								<option value="VIN-JET (Standard)" data-src="images/prod-images/vin-jet/vin-jet-main-stock.png">VIN-JET (Standard) $289.00</option>
				                <option value="VIN-JET (Deluxe)" data-src="images/prod-images/vin-jet/vin-jet-main.png">VIN-JET (Deluxe) $369.00</option>
				                <option value="VIN-JET (Standard w/Lundahl )" data-src="images/prod-images/vin-jet/vin-jet-main-stock.png">VIN-JET (Standard w/Lundahl) $459.00</option>
				                <option value="VIN-JET (Deluxe w/Lundahl)" data-src="images/prod-images/vin-jet/vin-jet-main.png">VIN-JET (Deluxe w/Lundahl) $539.00</option>
							</select>
							<input type="hidden" name="cmd" value="_s-xclick">
							<input type="hidden" name="hosted_button_id" value="YSM54TWEZPMRJ">
							<input type="hidden" name="on0" value="CHOOSE TRANSFORMER">
		...
		<section class="product-details grey-bg clearfix">
			<div class="left left-col">
				<article class="prod-desc">
					...
					<p>This current  is amplified to produce sound. What makes ribbon microphones so incredibly sensitive and accurate is that the signal comes directly from the material that senses the sound; nothing is lost in translation. The result is the most  intimate, warm, and articulate sound produced by any type of microphone. Ribbon microphones are an excellent choice for recording guitar cabinets, drum overheads and vocals.</p>

					<p>Neodymium rare earth permanent magnet  is a new kind of magnetic material developed in the 1980s with excellent magnetic characteristics in terms of a high-energy product, high coercive force etc. It is the strongest and most powerful magnetic material up to now and regarded as "The King of Magnets".</p>
				</article>
				...
				<article class="prod-specs">
					<div class="prod-specs-list">
						...
						<ul>
							...
							<li class="prod-specs-list-cell">99% Pure aluminum, 2.5 micron, 2 7/16" (L) X 3/16" (W)</li>
						</ul>
						<ul>
						...
						<ul>
							...
							<li class="prod-specs-list-cell">54.8 dB (1.8 mV/Pa)</li>
						</ul>
						<ul>
							<li class="prod-specs-list-cell">Frequency Response</li>
							<li class="prod-specs-list-cell"><a href="freq-resp/vj_mic_report_p.pdf" data-featherlight="iframe" data-featherlight-iframe-height="100%" data-featherlight-iframe-width="100%" class="cross-spectrum">View PDF for details</a></li>
						</ul>
						<ul>
							<li class="prod-specs-list-cell">SPL</li>
							<li class="prod-specs-list-cell">135dB SPL capability</li>
						</ul>
						<ul>
						...
						<ul>
							...
							<li class="prod-specs-list-cell">2 1/8" (O.D. grill),  2" (O.D. body)Overall length 8 3/8"</li>
						</ul>
						<ul>
							<li class="prod-specs-list-cell">Descriptors</li>
							<li class="prod-specs-list-cell">Smooth, natural extended low and high ends. Fast, accurate transient response. Wide, extended sweet spots. Ideal for stereo microphone setups.</li>
						</ul>
					</div>
