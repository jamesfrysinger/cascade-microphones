					...
					<div class="prod-buy-form">
						<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
							...
							<select class="dropkick" name="os0">
            					<option value="201-B VIIN-JET (STOCK TRANSFORMER)">Vin-Jet Stereo Pair (Stock Transformer 201-B) $579.00</option>
            					<option value="201-BL VIN-JET (LUNDAHL TRANSFORMER)">Vin-Jet Stereo Pair (Lundahl Transformer 201-BL) $919.00</option>
							</select>
							<input type="hidden" name="cmd" value="_s-xclick">
							<input type="hidden" name="hosted_button_id" value="W7MQY2B78TUDN">
