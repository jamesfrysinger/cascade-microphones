					...
					<div class="prod-buy-form">
						<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
							...
							<select class="dropkick" name="os0">
								<option value="Black Body/Silver Grill 98-B-A">Black Body/Silver Grill $229.00</option>
                				<option value="Brown Body/Gold Grill 98-G-A">Brown Body/Gold Grill $229.00</option>
							</select>
							<input type="hidden" name="cmd" value="_s-xclick">
							<input type="hidden" name="hosted_button_id" value="AFRKZC4EFXCPE">
