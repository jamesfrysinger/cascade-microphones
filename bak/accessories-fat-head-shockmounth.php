				...
				<div class="prod-buy-details-vert">
					...
					<div class="prod-buy-form">
						<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
							...
							<label for="select-option" style="display:none;">Select Color</label>
							<select class="dropkick" name="os0" id="select-option">
								<option value="#">Black Fat Head Shockmount $49.00</option>
							</select>
							<input type="hidden" name="cmd" value="_s-xclick">
							<input type="hidden" name="hosted_button_id" value="729WC5AXAKMQS">
