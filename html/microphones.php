...
<head>
	<title>Microphones, Ribbon Microphones, Studio Microphones, Recording Microphones, Touring Microphones | Cascade Ribbon Microphones</title>
	<meta name="description" content="View our catalog of world-class ribbon microphones. Our ribbon microphones are designed for professionals but essential for all."/>
	...
	<div class="minMax">
		<div class="clearfix">
			...
			<div class="clearfix right category-select">
				...
				<select tabindex="1" class="dropkick-jump right" name="Category" id="Category">
				  <option value="short-ribbon">Short Ribbon Series</option>
				  <option value="long-ribbon">Long Ribbon Series</option>
				  <option value="specialty">Specialty Series</option>
				  <option value="accessories">Accessories</option> 
				</select>
			</div>
		</div>

		<p class="thin-heading" id="short-ribbon">Short Ribbon Series</p>
		...
		<section class="microphones clearfix">
			...
			<article class="featured-prod clearfix grey-bg">
				...
				<div class="featured-prod-details">
					...
					<ul>
						<li>Symmetrical ribbon design</li>
						<li>Fitted w/ Lundahl LL2913 transformer</li> 
						<li>Additional transformer isolation</li>
						<li>Multiple body and grill choices</li>
						<li>Award winner</li> 
					</ul>
				</div>
			...
			<article class="featured-prod clearfix grey-bg">
				...
				<div class="featured-prod-details">
					<h2>Fat Head II <span>Stereo Pair</span></h2>
					<h4>Short Ribbon Microphone</h4>
					<ul>
						<li>Symmetrical ribbon design</li>
						<li>Fitted w/ Lundahl LL2913 transformer</li>
						<li>Cascade designed stereo bar</li>
						<li>Multiple body and grill choices</li>
						<li>Award winner</li>
					</ul>
				</div>
			...
			<article class="featured-prod clearfix grey-bg">
				...
				<div class="featured-prod-details">
					<h2>Fat Head <span>Stereo Pair</span></h2>
					<h4>Short Ribbon Microphone</h4>
					<ul>
						<li>Symmetrical ribbon design</li>
						<li>Cascade designed stereo bar</li>
			...
			<article class="featured-prod clearfix grey-bg">
				...
				<div class="featured-prod-details">
					...
					<h4>Short Ribbon Microphone</h4>
					<ul>
						<li>Bare essentials - Includes Mic clip and leatherette pouch</li>
			...
			<article class="featured-prod clearfix grey-bg">
				...
				<div class="featured-prod-details"> 
					<h2>Fat Head BE <span>Stereo Pair</span></h2>
					<h4>Short Ribbon Microphone</h4>
					<ul>
						<li>Bare essentials - Includes Mic clip and Cascade Design Blumlein stereo bar, leatherette pouch and molded flight case</li>
						<li>Famous warm tone</li>
					</ul>
				</div>
		...
		<p class="thin-heading" id="long-ribbon">Long Ribbon Series</p>
		...
		<section class="microphones clearfix">
			...
			<article class="featured-prod clearfix grey-bg">
				...
				<div class="featured-prod-details">
					...
					<ul>
						<li>Fitted w/ 2 7/16" long ribbon</li>
						<li>Upgradeable to Lundahl 2913</li>
						<li>Minimal screen material for open sound</li>
						<li>Award winner</li>
					</ul>
				</div>
			...
			<article class="featured-prod clearfix grey-bg">
				...
				<div class="featured-prod-details">
					<h2>VIN-JET <span>Stereo Pair</span></h2>
					<h4>Long Ribbon Microphone</h4>
					<ul>
						<li>Stereo Bar</li>
						<li>Fitted w/ 2 7/16" long ribbon</li>
		...
		<p class="thin-heading" id="specialty">Specialty Ribbon Series</p>
		...
		<section class="microphones clearfix">
			...
			<article class="products/featured-prod clearfix grey-bg">
				...
				<div class="products/featured-prod-details">
					...
					<h4>Short Ribbon Microphone</h4>
					<ul>
						<li>Patent Pending design that offers an Active / Passive mode</li>
						<li>+25db of additional clean gain in active mode</li>
						<li>Fitted w/ Lundahl LL2913 transformer</li>
			...
			<article class="featured-prod clearfix grey-bg">
				...
				<div class="featured-prod-details">
					<h2>X15-Stereo Short Ribbon</h2>
					<h4>Stereo Short Ribbon Microphone</h4>
					<ul>
						<li>Features 2 hand tuned symmetrical Ribbons</li>
						<li>Easy setup for stereo recording</li>
						<li>Superb Stereo Imaging</li>
						<li>Upgradeable to Lundahl LL2912</li>
						<li>Award winner</li>
					</ul>
				</div>
			...
			<article class="featured-prod clearfix grey-bg">
				...
				<div class="featured-prod-details">
					<h2>Knuckle Head Antique Copper</h2>
					<h4>Short Ribbon Microphone</h4>
					<ul>
						<li>Symmetrical ribbon design</li>
		...
		<p class="thin-heading" id="accessories">Accessories</p>
		...
		<section class="microphones clearfix">
			...
			<article class="featured-prod clearfix grey-bg">
				...
				<div class="featured-prod-details">
					<h2>FAT HEAD II / VIN-JET Shockmount <span>(Current Model)</span></h2>
					<h4>Microphone Shockmount</h4>
					<ul>
						<li>For use with Fat Head II, Vin-Jet Microphones and similar sized microphones</li>
			...
			<article class="featured-prod clearfix grey-bg">
				...
				<div class="featured-prod-details">
					<h2>Fat Head Shockmount</h2>
					<h4>Microphone Shockmount</h4>
					<ul>
						<li>For use with Fat Head Microphone and similar sized microphones</li>
			...
			<!-- FAT HEAD II Shockmount -->
			<!--
			<article class="featured-prod clearfix grey-bg">
				<a href="accessories-fat-head-ii-microphone-shockmount-prev-model" class="img-href">
					<img src="images/prod-images/fat-head-ii-shockmount-prev/fat-head-ii-shockmount-prev-main.png" alt="Fat Head II Ribbon Microphone Shock Mount Product Image" />
				</a>
				
				<div class="featured-prod-details">
					<h2>FAT HEAD II Shockmount <span>(Previous Model)</span></h2>
					<h4>Microphone Shockmount</h4>
					<ul>
						<li>For use with previous model Fat Head II Microphone and similar sized microphones</li>
						<li>33mm Universal Shockmount</li>
					</ul>
				</div>
				<a href="accessories-fat-head-ii-microphone-shockmount-prev-model" class="primary-btn">Shop Now</a>
			</article>-->
			...
			<article class="featured-prod clearfix grey-bg">
				...
				<div class="featured-prod-details">
					<h2>Stereo Blumlein Bar</h2>
					<h4>Stereo Microphone Attachment</h4>
					<ul>
